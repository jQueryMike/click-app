...
}: { dialogOpen: boolean, closeDialog: () => void, confirmAction: () => void | null | undefined, title: string, message: string }) => {

    const cancelButtonRef = useRef(null)

    return (
        <Transition.Root show={dialogOpen} as={Fragment}>
            <Dialog as="div" className="relative z-60" initialFocus={cancelButtonRef} onClose={closeDialog}>
                <Transition.Child
                    as={Fragment}
